...
public class ObtenerIdDocumentosBloqueFirmasBackwards extends StartingClass implements WebServicesAvailable
{
	...
	public static void main (String[] args)
	{
		...
		new ObtenerIdDocumentosBloqueFirmasBackwards().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getDocIdSignaturesBlockBackwardsWebServiceName + "...]");
		Document getDocIdSignaturesBlockBackwardsRequest = UtilsWebService.prepareGetDocIdSignaturesBlockBackwardsRequest(appId,new String(signaturesBlockBase64));
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getDocIdSignaturesBlockBackwardsWebServiceName, getDocIdSignaturesBlockBackwardsRequest);
