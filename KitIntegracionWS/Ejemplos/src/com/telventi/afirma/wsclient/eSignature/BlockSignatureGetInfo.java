...
public class BlockSignatureGetInfo extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> BlockSignatureGetInfo applicationId transactionId\n" +
		"\n" +
		"donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new BlockSignatureGetInfo().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getInformationSignaturesBlockWebServiceNameEng + "...]");
		Document getInformationSignatureBlockRequest = UtilsWebService.prepareGetInformationSignaturesBlockRequestEng(appId,idTransaction);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getInformationSignaturesBlockWebServiceNameEng, getInformationSignatureBlockRequest);
