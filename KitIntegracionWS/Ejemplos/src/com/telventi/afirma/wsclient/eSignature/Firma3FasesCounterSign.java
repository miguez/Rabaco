...
public class Firma3FasesCounterSign extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage =
		...
		"> Firma3FasesCounterSign idAplicacion idTransaccion [-r referenciaExterna] [-e extenderFormatoFirma]\n\n" +
		"  donde\n" +
...
//		"                                Valores posibles: ES-T\n";
	...
	{		
		...
		new Firma3FasesCounterSign().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + threePhasesUserSignatureF1CounterSignWebServiceName + "...]");
		Document threePhasesUserSignaturesF1CounterSignRequest = UtilsWebService.prepareThreePhasesUserSignaturesF1CounterSignRequest(appId,idTransaction);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(threePhasesUserSignatureF1CounterSignWebServiceName,threePhasesUserSignaturesF1CounterSignRequest);
