...
public class BlockSignatureGetInfoBackwards extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> BlockSignatureGetInfoBackwards applicationId block\n" +
		"\n" +
		"donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new BlockSignatureGetInfoBackwards().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getInformationSignaturesBlockBackwardsWebServiceNameEng + "...]");
		Document getInformationSignaturesBlockBackwardsRequest = UtilsWebService.prepareGetInformationSignaturesBlockBackwardsRequestEng(appId,new String(signaturesBlockBase64));
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getInformationSignaturesBlockBackwardsWebServiceNameEng, getInformationSignaturesBlockBackwardsRequest);
