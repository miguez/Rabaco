 ...
 *
 */
public class BlockSignatureValidationDocument extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> BlockSignatureValidationDocument idAplicacion firmaElectronicaAValidar documento idDocumento [-f formatoFirmaElectronica]\n" +
		"\n" +
		"donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new BlockSignatureValidationDocument().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + blockSignatureDocumentValidacionWebServiceNameEng + "...]");
		Document blockSignatureDocumentValidationRequest = UtilsWebService.prepareBlockSignatureDocumentValidationRequestEng(appId,new String(signatureBase64),new String(documentBase64),idDocument, signatureFormat);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(blockSignatureDocumentValidacionWebServiceNameEng, blockSignatureDocumentValidationRequest);
