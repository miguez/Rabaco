...
public class Firma3Fases extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage =
		...
		"> Firma3Fases idAplicacion ficheroAFirmar [-fe formatoFirmaElectronica] [-a algoritmoHash] [-r referenciaExterna] [-ef extenderFormatoFirma]\n\n" +
		"  donde\n" +
...
//		"                                     Valores posibles: ES-T\n";
	...
	public void run(String[] args)
	{
		...
		docId = UtilsWebService.getInfoFromDocumentNode(response, "idDocumento");
		...
		System.out.println(".[Preparando la petición al servicio Web " + threePhasesUserSignatureF1WebServiceName + "...]");
		Document threePhasesUserSignatureF1Request = UtilsWebService.prepareThreePhasesUserSignatureF1Request(appId, docId,  hashAlgorithm);
		System.out.println(".[/Petición correctamente preparada]");		
		...
		System.out.println("..[/peticion]");
		response = UtilsWebService.launchRequest(threePhasesUserSignatureF1WebServiceName,threePhasesUserSignatureF1Request);
		System.out.println("..[respuesta]");
		System.out.println(response);
		System.out.println("..[/respuesta]");		
		if (!UtilsWebService.isCorrect(response))
