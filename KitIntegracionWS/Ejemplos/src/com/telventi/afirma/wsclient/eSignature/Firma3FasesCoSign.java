...
public class Firma3FasesCoSign extends StartingClass implements	WebServicesAvailable {
	...
	private static final String errorMessage =
		...
		"> Firma3FasesCoSign idAplicacion idTransaccion [-a algoritmoHash] [-r referenciaExterna] [-ef extenderFormatoFirma]\n\n" +
		"  donde\n" +
...
//		"                                Valores posibles: ES-T\n";
	...
	public static void main(String[] args) {
		...
		new Firma3FasesCoSign().run(args);
	}
	...
	public void run(String[] args) {
		...
		System.out.println(".[Preparando la petición al servicio Web " + threePhasesUserSignatureF1CoSignWebServiceName + "...]");
		Document threePhasesUserSignaturesF1CoSignRequest = UtilsWebService.prepareThreePhasesUserSignaturesF1CoSignRequest(appId, idTransaction, hashAlgorithm);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(threePhasesUserSignatureF1CoSignWebServiceName, threePhasesUserSignaturesF1CoSignRequest);
		...
		// /////////////////////////////////////////////////////////////////////////////////
		// FASE 2 //
		// Realización de la firma electrónica del Hash y de la Firma
		// electronica.
		...
		System.out.println(".[Preparando la petición al servicio Web " + threePhasesUserSignatureF3WebServiceName + "...]");
		Document threePhasesUserSignatureF3Request = UtilsWebService.prepareThreePhasesUserSignatureF3Request(appId, transactionId, signatureValue, signCertificateValue, signatureFormat, updateSignatureFormat, referenceId);
		System.out.println(".[/Petición correctamente preparada]");
		...
		System.out.println("..[/peticion]");
		response = UtilsWebService.launchRequest(threePhasesUserSignatureF3WebServiceName, threePhasesUserSignatureF3Request);
		System.out.println("..[respuesta]");
		System.out.println(response);
		System.out.println("..[/respuesta]");
