...
public class ObtenerInfoCompletaBloqueFirmas extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> ObtenerInfoCompletaBloqueFirmas idAplicacion idTransaccion\n" +
		"\n" +
		"donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new ObtenerInfoCompletaBloqueFirmas().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getCompleteInfoSignaturesBlockWebServiceName + "...]");
		Document getCompleteInfoSignatureBlockRequest = UtilsWebService.prepareGetCompleteInfoSignaturesBlockRequest(appId,idTransaction);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getCompleteInfoSignaturesBlockWebServiceName, getCompleteInfoSignatureBlockRequest);
