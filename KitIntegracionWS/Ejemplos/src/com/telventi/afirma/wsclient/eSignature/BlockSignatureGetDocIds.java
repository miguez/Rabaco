...
public class BlockSignatureGetDocIds extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> BlockSignatureGetDocIds idAplicacion idTransaccion\n" +
		"\n" +
		"donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new BlockSignatureGetDocIds().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getDocIdSignaturesBlockWebServiceNameEng + "...]");
		Document getDocIdSignatureBlockRequest = UtilsWebService.prepareGetDocIdSignaturesBlockRequestEng(appId,idTransaction);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getDocIdSignaturesBlockWebServiceNameEng, getDocIdSignatureBlockRequest);
