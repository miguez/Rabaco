 ...
 *
 */
public class SetExternalReference extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> SetExternalReference applicationId transactionId reference\n" +
		"\n" +
		"  donde\n" +
		"   applicationId            --> Identificador de la aplicacion\n" +
		"   transactionId            --> Identificador de la transacción correspondiente al proceso de firma sobre la cual se desea actualizar la referencia externa\n" + 
	...
	public static void main (String[] args)
	{
		...
		new SetExternalReference().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + setExternalReferenceWebServiceNameEng + "...]");
		Document setExternalReferenceRequest = UtilsWebService.prepareSetExternalReferenceRequestEng(appId, transactionId, externalReference);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(setExternalReferenceWebServiceNameEng, setExternalReferenceRequest);
