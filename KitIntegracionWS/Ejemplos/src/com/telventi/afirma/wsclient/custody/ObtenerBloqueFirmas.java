 ...
 *
 */
public class ObtenerBloqueFirmas extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> ObtenerBloqueFirmas idAplicacion idTransaccion\n" +
		"\n" +
		"  donde\n" +
		"   idAplicacion             --> Identificador de la aplicacion\n" +
		"   idTransaccion            --> Identificador de la transacción correspondiente al proceso de firma de la cual se desea obtener el Bloque de Firmas Electrónicas\n"; 
	...
	public static void main (String[] args)
	{
		...
		new ObtenerBloqueFirmas().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		Document getSignaturesBlockRequest = UtilsWebService.prepareGetSignaturesBlockRequest(appId, transactionId);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getSignaturesBlockWebServiceName, getSignaturesBlockRequest);
		...
		String block = UtilsWebService.getInfoFromDocumentNode(response, "bloqueFirmas");
		if (block == null)
		{
