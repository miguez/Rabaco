 ...
 *
 */
public class GetESignature extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> GetESignature applicationId transactionId\n" +
		"\n" +
		"  donde\n" +
	...
	public void run(String[] args)
	{
		...
		Document getESignatureRequest = UtilsWebService.prepareGetESignatureRequestEng(appId, transactionId);
		...
		String eSignature = UtilsWebService.getInfoFromDocumentNode(response, "eSignature");
		String eSignatureFormat = UtilsWebService.getInfoFromDocumentNode(response, "eSignatureFormat");
