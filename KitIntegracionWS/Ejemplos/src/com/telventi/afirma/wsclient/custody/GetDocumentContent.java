 ...
 *
 */
public class GetDocumentContent extends StartingClass implements WebServicesAvailable 
{
	...
	private static final String errorMessage = 
		...
		"> GetDocumentContent applicationId transactionId\n" +
		"\n" +
		"  donde\n" +
		"   applicationId             --> Identificador de la aplicacion\n" +
		"   transactionId             --> Identificador de la transacción correspondiente al proceso de firma sobre el documento del cual se desea obtener el contenido\n"; 
	...
	public static void main (String[] args)
	{
		...
		new GetDocumentContent().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getDocumentContentWebServiceNameEng + "...]");
		Document getDocumentContentRequest = UtilsWebService.prepareGetDocumentContentRequestEng(appId, transactionId);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getDocumentContentWebServiceNameEng, getDocumentContentRequest);
