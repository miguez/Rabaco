 ...
 *
 */
public class StoreDocument extends StartingClass implements WebServicesAvailable 
{
	...
	private static final String errorMessage = 
		...
		"> StoreDocument applicationId ficheroACustodiar\n" +
		"\n" +
		"donde\n" +
	...
	public void run(String[] args)
	{
		...
		Document custodyDocumentRequest = UtilsWebService.prepareCustodyDocumentRequestEng(appId, fileName, fileType, new String(fileContentToRegister));
