 ...
 *
 */
public class GetDocId extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> GetDocId applicationId transactionId\n" +
		"\n" +
		"  donde\n" +
		"   applicationId             --> Identificador de la aplicacion\n" +
		"   transactionId             --> Identificador de la transacción correspondiente al proceso de firma sobre el documento del cual se desea obtener el identificador\n"; 
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getDocumentIdWebServiceNameEng + "...]");
		Document getDocumentIdRequest = UtilsWebService.prepareGetDocumentIdRequestEng(appId, transactionId);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getDocumentIdWebServiceNameEng, getDocumentIdRequest);
		...
		String documentIdValue = UtilsWebService.getInfoFromDocumentNode(response, "documentId");
