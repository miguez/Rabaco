/** 
* <p>Fichero: GetInfoCertificate.java</p>
* <p>Descripción: </p>
 ...
 *
 */
public class GetInfoCertificate extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> GetInfoCertificate applicationId certificadoAValidar\n" +
		"\n" +
		"  donde\n" +
	...
	public static void main (String[] args)
	{
		...
		new GetInfoCertificate().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + getCertificateInfoWebServiceNameEng + "...]");
		Document getCertificateInfoRequest = UtilsWebService.prepareGetCertificateInfoRequestEng(appId, new String(certificateContentToGetInfo));
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(getCertificateInfoWebServiceNameEng, getCertificateInfoRequest);
		System.out.println("..[respuesta]");
		System.out.println(response);
		System.out.println("..[/respuesta]");		
		if (!UtilsWebService.isCorrectGetCertificateInfoRequestEng(response))
		{
			System.err.println();
