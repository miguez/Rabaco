/** 
* <p>Fichero: ValidateCertificate.java</p>
* <p>Descripción: </p>
 ...
 *
 */
public class ValidateCertificate extends StartingClass implements WebServicesAvailable
{
	...
	private static final String errorMessage = 
		...
		"> ValidateCertificate applicationId certificadoAValidar [-m validationMode] [-i getInfo]\n" +
		"\n" +
		"  donde\n" +
		"   applicationId            --> Identificador de la aplicacion\n" +
		"   certificadoAValidar      --> Ruta completa al certificado a validar\n" +
		"   -m validationMode        --> Modo de Validación\n" +
		...
		"   -i getInfo                  --> Booleano que indica si se desea obtener información del certificado a validar.\n" +
	...
	public static void main (String[] args)
	{
		...
		new ValidateCertificate().run(args);
	}
	...
	public void run(String[] args)
	{
		...
		System.out.println(".[Preparando la petición al servicio Web " + certificateValidationWebServiceNameEng + "...]");
		Document certificateValidationRequest = UtilsWebService.prepareCertificateValidationRequestEng(appId, new String(certificateContentToValidate), validationMode, getCertificateInfo);
		...
		System.out.println("..[/peticion]");
		String response = UtilsWebService.launchRequest(certificateValidationWebServiceNameEng, certificateValidationRequest);
		System.out.println("..[respuesta]");
		System.out.println(response);
		System.out.println("..[/respuesta]");	
		
		//Comprobamos el resultado de la validacion
		System.out.println("     >>>>> " + UtilsWebService.getResultCertificateValidationRequestEng(response));
				...
				while (i < args.length) {
					...
					if (opcion.startsWith("-")) {
						...
						if (opcion.equals("-m")) {
							...
							i++;
							getCertificateInfo = new Boolean(args[3]).booleanValue();
						} else {
							throw new Exception();
						}
					} else {
